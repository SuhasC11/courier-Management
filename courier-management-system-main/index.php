...
<head>
    ...
    <style>
        body {
            background-image: url('C:\xampp\htdocs\cmsm\courier-management-system-main\images\Male-couriers-delivering-parcels.jpg');
...
<body>
    ...
    <hr />
    <P align='center' style="font-weight: bold;color:orange;font-family:'Times New Roman', Times, serif">AS FAST AS ROCKET!!!</P>
    <div>
